                        ...
                        <Column
                            ...
                            render={(text, record) => (
                                <span>
                                    ...
                                    <Popconfirm title={(<span><p>¿Esta seguro de reactivar el docente?</p><p>al realizar esta acción, se hara visible todo la información relacionada a este docente</p></span>)} onConfirm={() => this.handleEliminar(record.id, record.id_usuario)} okText="Si" cancelText="Cancelar">
