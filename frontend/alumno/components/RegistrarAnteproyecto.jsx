...
const CreateRegistrarProyecto = Form.create()(
    (props => {
        const { handleSubmit, form, anteproyecto, empresas, docentes, normFile, beforeUpload } = props;
            ...
            >
                ...
                <FormItem
                    label={(
                        <span>
                            Asesor interno&nbsp;
                            <Tooltip title="Seleccione solo si esta validado su participacion del asesor">
                                <Icon type="question-circle-o" />
                            </Tooltip>
                        </span>
                    )}
                ...
                >
                    ...
                    {getFieldDecorator('id_asesor_interno', {
                ...
                <FormItem
                    label={(
                        <span>
                            Tipo de proyecto&nbsp;
                            <Tooltip title="Seleccione su tipo de proyector">
                                <Icon type="question-circle-o" />
                            </Tooltip>
                        </span>
                    )}
                ...
                >
                    ...
                    {getFieldDecorator('tipo_proyecto', {
                        rules: [{ required: false, message: '' }],

                    })(
                        <Select
                            placeholder="Seleccionde el tipo del proyecto"
                            style={{ width: '80%' }}
                        >
...
export default class RegistrarAnteproyecto extends Component {
    ...
    handleSubmit = (e) => {
        ...
        form.validateFields((err, values) => {
            ...
            const id_asesor_externo = values.id_asesor_externo,
                ...
                id_asesor_interno= values.id_asesor_interno,
                tipo= values.tipo_proyecto;
    ...
    render() {
        const { anteproyecto, empresas, docentes } = this.state
